<x-app-layout>
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="text-lg font-semibold text-slate-800">Form Input Nilai</h3>
        </div>
        <div class="card-body">
            <form action="{{ route('nilai.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="nilai" value="{{ old('nilai') }}" class="form-control" min="0" max="100" required>
                        @error('nilai')
                            <span class="text-sm text-[#EF4444] mt-1 block">{{ $message }}</span>
                        @enderror
                    </div>
